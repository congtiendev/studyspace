            ...
            <div class="table-responsive text-center">
                <table class="table table-striped font-14">
                    ...
                    <th>#</th>
                        ...
                        <th><?php echo e(trans('admin/main.total_purchase_price')); ?></th>
                        <th><?php echo e(trans('admin/main.total_price')); ?></th>
                     ...
                     <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="media-body">
                                    <div class="text-small font-600-bold"><?php echo e(handlePrice($user->getAccountingBalance() + $user->classesPurchasedsSum)); ?></div>
                                </div>
                            </td>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/admin/domains/snapstudy.edu.vn/public_html/resources/views/admin/users/students.blade.php ENDPATH**/ ?>