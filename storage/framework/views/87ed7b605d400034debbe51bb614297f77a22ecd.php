        ...
        <div class="d-flex align-items-center ">
            <?php if(!empty($user) and empty($new_user)): ?>
                <?php if(!empty($currentStep) and $currentStep > 1): ?>
                    <a href="/panel/setting/step/<?php echo e(($currentStep - 1)); ?>" class="btn btn-sm btn-primary mr-2"><?php echo e(trans('webinars.previous')); ?></a>
                <?php else: ?>
                    <a href="" class="btn btn-sm btn-primary disabled"><?php echo e(trans('webinars.previous')); ?></a>
                <?php endif; ?>

                <button type="button" id="getNextStep" class="btn btn-sm btn-primary ml-1" <?php if(!empty($currentStep) and (($user->isUser() and $currentStep == 8))): ?> disabled <?php endif; ?>><?php echo e(trans('webinars.next')); ?></button>
            <?php endif; ?>
        </div>

        <div class="d-flex align-items-center">
            <?php if(empty($new_user) and empty($edit_new_user)): ?>
                <a href="/panel/setting/deleteAccount" class="delete-action btn btn-sm btn-danger ml-2" data-confirm="<?php echo e(trans('update.delete_account_modal_confirm_btn_text')); ?>" data-title="<?php echo e(trans('update.delete_account_modal_hint')); ?>"><?php echo e(trans('update.delete_account')); ?></a>
            <?php endif; ?>

            <button type="button" id="saveData" class="btn btn-sm btn-primary ml-2"><?php echo e(trans('public.save')); ?></button>
        </div>
    </div>
...
<?php echo $__env->make(getTemplate() .'.panel.layouts.panel_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/admin/domains/snapstudy.edu.vn/public_html/resources/views/web/default/panel/setting/index.blade.php ENDPATH**/ ?>