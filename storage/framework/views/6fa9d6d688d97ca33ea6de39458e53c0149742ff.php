            ...
            <div class="row">
                <div class="col-4 d-flex align-items-center justify-content-center">
                    <div class="d-flex flex-column align-items-center text-center">
                        ...
                        <strong class="font-30 text-dark-blue font-weight-bold mt-5" style="white-space: nowrap;"><?php echo e($availablePoints); ?></strong>
                        <span class="font-16 text-gray font-weight-500" style="white-space: nowrap;"><?php echo e(trans('update.available_points')); ?></span>
                    </div>
                </div>
                ...
                <div class="col-4 d-flex align-items-center justify-content-center">
                    <div class="d-flex flex-column align-items-center text-center">
                        ...
                        <strong class="font-30 text-dark-blue font-weight-bold mt-5" style="white-space: nowrap;"><?php echo e($totalPoints); ?></strong>
                        <span class="font-16 text-gray font-weight-500" style="white-space: nowrap;"><?php echo e(trans('update.total_points')); ?></span>
                    </div>
                </div>
                ...
                <div class="col-4 d-flex align-items-center justify-content-center">
                    <div class="d-flex flex-column align-items-center text-center">
                        ...
                        <strong class="font-30 text-dark-blue font-weight-bold mt-5" style="white-space: nowrap;"><?php echo e($spentPoints); ?></strong>
                        <span class="font-16 text-gray font-weight-500" style="white-space: nowrap;"><?php echo e(trans('update.spent_points')); ?></span>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="col-12 col-lg-6 mt-20 mt-lg-0">
            <div class="d-flex align-items-center justify-content-between rounded-sm bg-white p-15 shadow-lg">
                ...
                <div class="flex-grow-1 ml-15 text-right">
                    <a href="<?php echo e((!empty($rewardsSettings) and !empty($rewardsSettings['want_more_points_link'])) ? $rewardsSettings['want_more_points_link'] : ''); ?>" class="btn btn-sm btn-border-white d-none"><?php echo e(trans('update.view_more')); ?></a>
                </div>
            </div>
...
<?php echo $__env->make('web.default.panel.layouts.panel_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/admin/domains/snapstudy.edu.vn/public_html/resources/views/web/default/panel/rewards/index.blade.php ENDPATH**/ ?>