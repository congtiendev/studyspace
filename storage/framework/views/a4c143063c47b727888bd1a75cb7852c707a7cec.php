    ...
    <section class="section">
        ...
        <div class="section-body">
            ...
            <div class="d-flex align-items-center justify-content-between">
                ...
                <a href="" class="btn btn-primary"><?php echo e(trans('admin/main.export_xls')); ?></a>
            </div>
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped font-14">
                                    <tr>
                                        ...
                                        <th class="text-center"><?php echo e(trans('admin/main.email')); ?></th>
                                        ...
                                        <?php $__currentLoopData = $documents; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $document): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                                                ...
                                                <td class="text-left">
                                                    <?php if(!empty($document->user)): ?>
                                                        <a href="<?php echo e(getAdminPanelUrl()); ?>/users/<?php echo e($document->user_id); ?>/edit" target="_blank"
                                                           class=""><?php echo e($document->user->email); ?></a>
                                                    <?php endif; ?>
                                                </td>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/admin/domains/snapstudy.edu.vn/public_html/resources/views/admin/financial/documents/lists.blade.php ENDPATH**/ ?>