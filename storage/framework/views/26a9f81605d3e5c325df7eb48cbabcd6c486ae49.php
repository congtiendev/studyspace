...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="row">
                    <div class="col-12 col-lg-8 d-flex align-items-center">
                        ...
                        <button type="submit" class="btn btn-primary btn-sm ml-40 mt-10 btn-new-mj"><?php echo e(trans('site.send_message')); ?></button>
                    </div>
                </div>
            </div>
        </section>
...
<?php echo $__env->make(getTemplate() .'.panel.layouts.panel_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/admin/domains/snapstudy.edu.vn/public_html/resources/views/web/default/panel/support/new.blade.php ENDPATH**/ ?>