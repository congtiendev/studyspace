...
/*!**************************************************!*\
  !*** ./resources/js/panel/meeting/join_modal.js ***!
  \**************************************************/
(function ($) {
  "use strict";
  ...
  $('body').on('click', '.js-join-reserve', function (e) {
    ...
    var meeting_password = $('.js-meeting-password-' + reserve_id).val();
    var meeting_link = $('.js-meeting-link-' + reserve_id).val();
    var $modalHtml = $('#joinMeetingLinkModal');
    Swal.fire({
